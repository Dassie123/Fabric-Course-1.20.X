package net.petrus.mccourse.block;
...
import net.petrus.mccourse.block.custom.SoundBlock;
...
public class ModBlocks {
    ...
    public static final Block PINK_GARNET_WALL = registerBlock("pink_garnet_fence_wall",
